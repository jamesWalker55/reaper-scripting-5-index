...
function Track.prototype.setName(self, name)
...
function Source.prototype.getFilename(self)
    return reaper.GetMediaSourceFileName(self.obj)
end
...
do
    ...
    function TrackRouting.getAudioInfo(self, track, category, idx)
        ...
        local channelCount
        repeat
            local ____switch158 = I_SRCCHAN >> 10
            local ____cond158 = ____switch158 == 0
            if ____cond158 then
                channelCount = 2
                break
            end
            ____cond158 = ____cond158 or ____switch158 == 1
            if ____cond158 then
                channelCount = 1
                break
            end
    ...
    function TrackRouting.getParentMidiInfo(self, track)
        ...
        repeat
            local ____switch165 = I_MIDI_CTL_CHAN
            local ____cond165 = ____switch165 == 16
            if ____cond165 then
