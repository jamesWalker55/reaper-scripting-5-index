...
local ____exports = {}
local log = require("lua_modules.reaper-microui.build.log")
...
local function deferLoop(self, func)
...
function ____exports.microUILoop(self, ctx, func)
    local downKeys = {
        left = false,
        middle = false,
        right = false,
    ...
    deferLoop(
        ...
        function(____, stop)
            ...
            for ____, cmd in __TS__Iterator(ctx:iterCommands()) do
                repeat
                    local ____switch21 = cmd.type
                    local ____cond21 = ____switch21 == CommandType.Clip
                    if ____cond21 then
                        do
                    ...
                    ____cond21 = ____cond21 or ____switch21 == CommandType.Rect
                    if ____cond21 then
                        do
                    ...
                    ____cond21 = ____cond21 or ____switch21 == CommandType.Text
                    if ____cond21 then
                        do
                            gfx.r = cmd.color.r / 255
                            gfx.g = cmd.color.g / 255
                    ...
                    ____cond21 = ____cond21 or ____switch21 == CommandType.Icon
                    if ____cond21 then
                        do
                            gfx.r = cmd.color.r / 255
                            gfx.g = cmd.color.g / 255
                            ...
                            gfx.y = cmd.rect.y
                            repeat
                                local ____switch31 = cmd.id
                                local ____cond31 = ____switch31 == IconId.Close
                                if ____cond31 then
                                    do
                                ...
                                ____cond31 = ____cond31 or ____switch31 == IconId.Check
                                if ____cond31 then
                                    do
                                        gfx.drawstr("✓", DrawStrFlags.CenterHorizontally | DrawStrFlags.CenterVertically, cmd.rect.x + cmd.rect.w, cmd.rect.y + cmd.rect.h)
                                        break
                                ...
                                ____cond31 = ____cond31 or ____switch31 == IconId.Collapsed
                                if ____cond31 then
                                    do
                                        gfx.drawstr("▸", DrawStrFlags.CenterHorizontally | DrawStrFlags.CenterVertically, cmd.rect.x + cmd.rect.w, cmd.rect.y + cmd.rect.h)
                                        break
                                ...
                                ____cond31 = ____cond31 or ____switch31 == IconId.Expanded
                                if ____cond31 then
                                    do
                                        gfx.drawstr("▾", DrawStrFlags.CenterHorizontally | DrawStrFlags.CenterVertically, cmd.rect.x + cmd.rect.w, cmd.rect.y + cmd.rect.h)
                                        break
            ...
            if ctx:beginWindow("Demo Window", {x = 0, y = 0, w = 0, h = 0}, Option.NoResize | Option.NoTitle | Option.NoClose) then
                ...
                if ctx:header("Tree and Text", Option.Expanded) then
                    ...
                    if ctx:beginTreenode("Test 2") then
                        ...
                        if ctx:button("Button 4") then
                            log.info("Pressed button 4")
                        end
                        if ctx:button("Button 5") then
                            log.info("Pressed button 5")
                        end
                        if ctx:button("Button 6") then
                            log.info("Pressed button 6")
                        end
                        ctx:endTreenode()
                    end
                    if ctx:beginTreenode("Test 3") then
