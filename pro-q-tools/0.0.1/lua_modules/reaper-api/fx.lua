...
function ReaperFXChain.prototype.Delete(self, fxidx)
    repeat
        local ____switch86 = self.obj.type
        local ____cond86 = ____switch86 == "track"
        if ____cond86 then
            do
                return reaper.TrackFX_Delete(self.obj.track, fxidx)
            end
        end
        ____cond86 = ____cond86 or ____switch86 == "take"
        if ____cond86 then
            do
                return reaper.TakeFX_Delete(self.obj.take, fxidx)
            end
        end
        do
            assertUnreachable(nil, self.obj)
...
function ReaperFXChain.prototype.EndParamEdit(self, fxidx, param)
    repeat
        local ____switch90 = self.obj.type
        local ____cond90 = ____switch90 == "track"
        if ____cond90 then
            do
                return reaper.TrackFX_EndParamEdit(self.obj.track, fxidx, param)
            end
        end
        ____cond90 = ____cond90 or ____switch90 == "take"
        if ____cond90 then
            do
                return reaper.TakeFX_EndParamEdit(self.obj.take, fxidx, param)
            end
        end
        do
            assertUnreachable(nil, self.obj)
...
function FX.prototype.getParameterUnchecked(self, param)
    repeat
        local ____switch99 = self.obj.type
        local ____cond99 = ____switch99 == "track"
        if ____cond99 then
            do
                return __TS__New(____exports.FXParam, {track = self.obj.track}, self.fxidx, param)
            end
        end
        ____cond99 = ____cond99 or ____switch99 == "take"
        if ____cond99 then
            do
...
function FX.prototype.getParameter(self, param)
    ...
    if not (0 <= param and param < totalCount) then
        error(
            __TS__New(
                Error,
                (("Param index " .. tostring(param)) .. " out of bounds of ") .. tostring(totalCount)
            ),
            0
        )
    end
    return self:getParameterUnchecked(param)
end
function FX.prototype.getParameters(self)
    ...
    do
        ...
        while i < totalCount do
            result[#result + 1] = self:getParameterUnchecked(i)
            i = i + 1
        end
    end
    return result
...
function FX.prototype.getName(self)
    repeat
        local ____switch107 = self.obj.type
        local ____cond107 = ____switch107 == "track"
        if ____cond107 then
            do
        ...
        ____cond107 = ____cond107 or ____switch107 == "take"
        if ____cond107 then
            do
...
function FX.prototype.rename(self, name)
    repeat
        local ____switch113 = self.obj.type
        local ____cond113 = ____switch113 == "track"
        if ____cond113 then
            do
        ...
        ____cond113 = ____cond113 or ____switch113 == "take"
        if ____cond113 then
            do
...
function FX.prototype.getElement(self)
    repeat
        local ____switch128 = self.obj.type
        local ____cond128 = ____switch128 == "track"
        if ____cond128 then
            do
        ...
        ____cond128 = ____cond128 or ____switch128 == "take"
        if ____cond128 then
            do
                error(
